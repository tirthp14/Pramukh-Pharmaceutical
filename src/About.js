...
function About() {
    ...
    return(
        <div>
                    ...
                    <div class="md:hidden">
                        <div id="menu" class="z-50 absolute flex-col items-center hidden self-end mt-10 space-y-6 font-bold sm:w-auto sm:self-center left-6 right-6 drop-shadow-md">
                            <ul class="w-full font-medium flex flex-col p-4 border border-gray-200 rounded-lg bg-gray-100 rtl:space-x-reverse">
                                ...
                                <li>
                                    <a href="About Us.html" class="block py-2 px-3 text-white bg-blue-700 rounded" aria-current="page">About Us</a>
                                </li>
                                <li>
            ...
            <main class="bg-gradient-to-b from-white to-[#f5f5f4]">
                {/* About Us */}
                <section class="md:py-14 md:mb-6 bg-transparent items-center font-poppins">
                    <div class="justify-center flex-1 max-w-7xl py-4 mx-auto lg:py-6 md:px-6">
                        <div class="flex flex-wrap">
                            <div class="w-full px-4 md:pr-12 mb-10 lg:w-1/2 lg:mb-0">
                                <div class="relative">
                                    ...
                                    <div
                                        class="absolute z-10 hidden w-full h-full bg-mainBlue rounded-bl-[80px] rounded-tr-[80px] rounded -bottom-6 right-6 lg:block">
                                    </div>
                                </div>
                            </div>
                            <div class="w-full px-4 md:pl-12 mb-7 lg:w-1/2 lg:mb-0 ">
                                <div class="relative">
                                    <h1
                                        class="absolute -top-20 left-0 text-[20px] lg:text-[100px] text-gray-900 font-bold opacity-5 md:block hidden">
                                        About Us
                                    </h1>
                                    <h1 class="pl-6 md:pl-2 text-3xl font-bold border-l-8 border-mainBlue md:text-5xl">
                                ...
                                <a href="#"
                                    class="font-medium px-4 py-3 transition-all transform border-2 border-mainGreen text-mainGreen rounded-[80px] hover:bg-lighterGreen hover:border-lighterGreen hover:text-gray-50">
                                    Learn more
                                </a>
                            </div>
                        </div>
                ...
                <section class="flex items-center font-poppins md:pb-6">
                    <div class="justify-center flex-1 max-w-6xl py-4 mx-auto lg:py-6 md:px-6">
                        <div class="flex flex-wrap-reverse items-center">
                            <div class="w-full px-4 mb-10 lg:w-1/2 lg:mb-0 relative">
                                <div>
                                    <div class="relative">
                                        <div class="absolute -top-16 left-0 text-[20px] lg:text-[74px] text-gray-900 font-bold opacity-5 md:block hidden">
                                            Who we are?
                                        </div>
                                        <h1 class="pl-6 md:pl-2 text-3xl font-bold border-l-8 border-mainBlue md:text-5xl">
                                    ...
                                    <div class="text-center space-x-20">
                                        <Link to="/services" class="font-medium px-4 py-3 transition-all transform border-2 border-mainGreen text-mainGreen rounded-[80px] hover:bg-lighterGreen hover:border-lighterGreen hover:text-gray-50">
                                            Services
                                        </Link>
                                        <Link to="/branches" class="font-medium px-4 py-3 transition-all transform border-2 border-mainGreen text-mainGreen rounded-[80px] hover:bg-lighterGreen hover:border-lighterGreen hover:text-gray-50">
                                            Branches
                                        </Link>
                                    </div>
                                </div>
                            </div>
                            <div class="w-full px-4 md:px-0 mb-10 lg:w-1/2 lg:mb-0 md:pl-20">
                                <div class="flex mb-4">
                                    <span
                                        class="flex items-center justify-center flex-shrink-0 w-12 h-12 mr-6 bg-darkerBlue rounded text-gray-50">
                ...
                <section class="flex items-center">
                    <div class="p-4 mx-auto max-w-7xl mt-4 mb-4">
                        <div class="text-center mb-14 relative">
                            <div class="absolute hidden md:block -top-3 left-72 text-8.2xl text-gray-400 font-bold opacity-10">
                                Testimonial
                            </div>
                            <h1 class="mb-10 text-6xl font-bold">Client Testimonial</h1>
                        ...
                        <div class="flex ">
                            <div class="grid grid-cols-1 gap-4 lg:gap-8 sm:gap-4 sm:grid-cols-2 lg:grid-cols-3">
                                <div>
                                    <div class="flex items-center justify-center mb-5 gap-x-4">
                                        <div class="relative w-24 h-24 rounded-full">
                                            ...
                                            <img class="object-cover w-full h-full rounded-full"
                                                src="/img/Testimonials/Review-2.png" alt=""/>
                                        </div>
                                        <div class="info">
                                            <h2 class="text-lg font-bold text-black">
                                                Stephen Attiku
                                            </h2>
                                            <span class="block text-xs font-semibold text-blue-500 uppercase">
                                                Customer
                                            </span>
                                    ...
                                    <div class="relative mb-8 bg-white rounded-xl shadow">
                                        <div class="absolute inline-block overflow-hidden -translate-x-1/2 w-7 -top-4 left-1/2">
                                            <div
                                                class="w-4 h-4 origin-bottom-left transform rotate-45 bg-white drop-shadow">
                                            </div>
                                        </div>
                                ...
                                <div>
                                    <div class="flex items-center justify-center mb-5 gap-x-4">
                                        <div class="relative w-24 h-24 rounded-full">
                                            ...
                                            <img class="object-cover w-full h-full rounded-full" src="/img/Testimonials/Review-1.png" alt=""/>
                                        </div>
                                        <div class="info">
                                            <h2 class="text-lg font-bold text-black">
                ...
                <section class="font-poppins">
                    <div class="justify-center flex-1 max-w-5xl p-4 pb-16 mx-auto lg:py-10 md:px-7">
                        <div class="max-w-xl mx-auto">
                            <div class="text-center ">
                                <div class="relative flex flex-col items-center">
                                    ...
                                    <h1 class="text-6xl font-bold text-gray-900"> Our <span class="text-mainBlue"> Contact
                                        </span> </h1>
                                    <div class="flex w-24 mt-1 mb-10 overflow-hidden rounded">
                                        <div class="flex-1 h-2 bg-blue-200">
                                        </div>
                                        <div class="flex-1 h-2 bg-mainBlue">
                                        </div>
                                        <div class="flex-1 h-2 bg-darkerBlue">
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="flex flex-wrap mb-6 md:mb-12 -mx-4">
                            <div class="w-full px-4 mb-10 lg:w-1/3 lg:mb-0">
                                <div class="h-full py-12 text-center rounded-lg shadow bg-white hover:shadow-lg hover:scale-105 transition-transform duration-500">
                                    <i class="fa-solid fa-envelope fa-xl text-mainBlue bg-gray-500 bg-opacity-30 p-5 py-7 rounded-lg m-3.5 mt-0"></i>
                                    <h2 class="mb-4 text-xl font-bold leading-9 text-gray-700 md:text-2xl">
                                        Email Us:</h2>
                                    <p class="text-base font-medium text-gray-500 md:text-base p-2">
                            ...
                            <div class="w-full px-4 mb-10 lg:w-1/3 lg:mb-0">
                                <div class="h-full py-12 text-center rounded-lg shadow bg-white hover:shadow-lg hover:scale-105 transition-transform duration-500">
                                    <i class="fa-solid fa-phone fa-xl text-mainBlue bg-gray-500 bg-opacity-30 p-5 py-7 rounded-lg m-3.5 mt-0"></i>
                                    <h2 class="mb-4 text-xl font-bold leading-9 text-gray-700 md:text-2xl">
                                        Call Us:</h2>
                                    <p class="text-base font-medium text-gray-500 md:text-base p-2">
                            ...
                            <div class="w-full px-4 mb-10 lg:w-1/3 lg:mb-0">
                                <div class="h-full py-12 text-center rounded-lg shadow bg-white hover:shadow-lg hover:scale-105 transition-transform duration-500">
                                    <i class="fa-solid fa-location-dot fa-xl text-mainBlue bg-gray-500 bg-opacity-30 p-5 py-7 rounded-lg m-3.5 mt-0"></i>
                                    <h2 class="mb-4 text-xl font-bold leading-9 text-gray-700 md:text-2xl">
                                        Address: (Main Branch)
                                    </h2>
                                    <p class="text-base font-medium text-gray-500 md:text-base p-2">
                        ...
                        <div class="p-4 md:p-12 bg-white border rounded-3xl shadow-md">
